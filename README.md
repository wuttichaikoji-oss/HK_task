...
## แก้ไขใน v1.8.2
- แก้ลิงก์จากหน้า Front Office ไปหน้าบอร์ดรวม
- ตัดฟิลด์ตึกและชั้นออกจากหน้า FO ให้กรอกเลขห้องอย่างเดียว
- ช่องผู้รับงาน HK เอาข้อความตัวอย่างออก เหลือช่องว่างเปล่า


## แก้ไขใน v1.8.3
- เอาแถบกรองทั้งหมดบนหน้าบอร์ดรวมออก
- ปรับหน้าบอร์ดรวมให้ใหญ่ขึ้น กว้างขึ้น ใช้งานง่ายทั้งคอมและมือถือ
- เปลี่ยนโทนสีเป็นดำเรียบหรู และปรับสีตัวอักษรให้อ่านง่ายขึ้น


## แก้ไขใน v1.8.4
- เอาแถบ Outlet / ตึก / ชั้น / สถานะ/ห้อง / ค้นหา ออกจากหน้าบอร์ดรวมทั้งหมด
- เปลี่ยนหัวข้อหน้าบอร์ดเป็น HOUSEKEEPING TASK
